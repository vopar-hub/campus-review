package com.vapor.review.interaction.service.impl;
...
import com.vapor.review.interaction.entity.FavoriteEntity;
import com.vapor.review.interaction.entity.LikeEntity;
import com.vapor.review.interaction.mapper.FavoriteMapper;
import com.vapor.review.interaction.mapper.LikeMapper;
import com.vapor.review.interaction.service.InteractionAppService;
 ...
 */
@Service
public class InteractionAppServiceImpl implements InteractionAppService {
    private static final Logger log = LoggerFactory.getLogger(InteractionAppServiceImpl.class);
     ...
     */
    public InteractionAppServiceImpl(LikeMapper likeMapper, FavoriteMapper favoriteMapper) {
