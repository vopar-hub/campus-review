...
public class UserAccountService {
     ...
     */
    public UserAccountService(UserMapper userMapper, PasswordEncoder passwordEncoder, JwtService jwtService) {
     ...
     * @param request 注册请求
     * @return 注册成功后的用户信息
     * @throws BizException 参数非法或邮箱/学号已存在时抛出
     */
    @Transactional
     ...
     * @throws BizException 账号不存在/密码错误/账号被封禁时抛出
     */
